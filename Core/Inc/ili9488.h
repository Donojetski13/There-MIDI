...
void drawCharBG(int16_t x, int16_t y, unsigned char c, uint16_t fg, uint16_t bg, uint8_t size);
void drawTextBG(int16_t x, int16_t y, const char *text, uint16_t color, uint16_t bg, uint8_t size);
void drawNoteWithSharpBG(int16_t x, int16_t y, const char *note, uint16_t fg, uint16_t bg, uint8_t mainSize, uint8_t sharpSize);   // size for '#'
