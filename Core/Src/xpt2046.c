...
#define XPT2046_X_MIN  220
#define XPT2046_X_MAX  3900
#define XPT2046_Y_MIN  380
...
uint16_t xpt2046_read_adc(uint8_t cmd)
{
    ...
    HAL_SPI_Transmit(spiPort, &tx, 1, HAL_MAX_DELAY);
    HAL_SPI_Receive(spiPort, rx, 2, HAL_MAX_DELAY);
...
void xpt2046_read_touch(uint16_t *x, uint16_t *y)
{
