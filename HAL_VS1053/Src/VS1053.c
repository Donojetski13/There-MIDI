...
//	uint8_t dummy = 0xFF;
	...
	if(HAL_SPI_TransmitReceive(HSPI_VS1053, rxBuffer, &rxBuffer[0], 1, 10) != HAL_OK) return 13;
	if(HAL_SPI_TransmitReceive(HSPI_VS1053, rxBuffer, &rxBuffer[1], 1, 10) != HAL_OK) return 13;
	XCS_HIGH;       /* XCS High */
